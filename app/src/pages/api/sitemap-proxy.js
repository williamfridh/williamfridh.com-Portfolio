/**
 * This file is a proxy for the WordPress sitemap.
 * It allows us to fetch the sitemap from WordPress and replace all URLs with the current site URL.
 * 
 * SRC: https://robertmarshall.dev/blog/use-yoast-sitemap-with-next-js-and-headless-wordpress/
 */

import fetch from 'isomorphic-unfetch';

const WORDPRESS_URL = process.env.NEXT_PUBLIC_WP_URL; // e.g. 'https://my-wordpressdomain.com'
const FRONTEND_URL = process.env.NEXT_PUBLIC_FRONTEND_URL; // e.g. 'https://localhost:3000'
